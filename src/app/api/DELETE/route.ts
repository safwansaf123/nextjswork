...
export function DELETE(){                         //POST api or custom api to post data 
...
// THIS "DELETE" API WILL NOT WORK ON BROWSER BECAUSE YOU NEED TO UPDATE DATA BASE
//  ON BROWSER "GET" API WILL WORK ONLY BECAUSE JUST CALLING
// FOR DELETE API YOU NEED POSTMAN EXTENSION